...
class AccordianPageLocators:
    ...
    SECTION_CONTENT_FIRST = (By.CSS_SELECTOR, 'div[id="section1Content"] p')  #  текст находится в параграфе - p
    ...
    SECTION_CONTENT_THIRD = (By.CSS_SELECTOR, 'div[id="section2Content"] p')

class AutoCompletePageLocators:
    MULTI_INPUT = (By.CSS_SELECTOR, 'input[id="autoCompleteMultipleInput"]')
    MULTI_VALUE = (By.CSS_SELECTOR, 'div[class="auto-complete__multi-value__label css-9jq23d"]')
    MULTI_VALUE_REMOVE = (By.CSS_SELECTOR, 'div[class="auto-complete__multi-value__remove css-v7duua"] svg path')
    SINGLE_VALUE = (By.CSS_SELECTOR, 'div[class="auto-complete__single-value css-1dimb5e-singleValue"]')
...
class DatePickerPageLocators:
    ...
    DATE_AND_TIME_MONTH = (By.CSS_SELECTOR, 'span[class="react-datepicker__month-read-view--selected-month"]')
...
class MenuPageLocators:
    NEW_ITEM_LIST = (By.CSS_SELECTOR, 'ul[id="nav"] li a')
