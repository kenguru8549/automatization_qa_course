...
class FormPageLocators():
    ...
    GENDER = (By.CSS_SELECTOR, f"div[class*='custom-control'] label[for='gender-radio-{random.randint(1,3)}']")  #  сделали f-строкой и из 3 вариантов рандомно будет выбираться любой с пом рандома
