...
class TextBoxPageLocators:
    ...
    CURRENT_ADDRESS = (By.CSS_SELECTOR, "textarea[id='currantAddress']")  #  локатор поля Current Address
    ...
    CREATED_CURRENT_ADDRESS = (By.CSS_SELECTOR, "#output #currantAddress']")  #  локатор поля Email
